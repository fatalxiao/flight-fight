...
### v3.3.0 (最新) - 界面优化和敌机修复
- 🎨 **移除蓝色边框**：去掉viewport周围的蓝色边框，界面更加简洁
- 🎯 **敌机移动修复**：彻底修复敌机移动到左侧边缘的问题，限制所有运动模式在屏幕中央区域
- ⚡ **运动优化**：降低敌机左右移动速度，确保更好的游戏体验
- 🎮 **边界控制**：所有敌机运动模式都限制在屏幕10%-90%范围内
- 🔧 **代码优化**：改进敌机运动逻辑，确保圆形、螺旋等复杂运动都以屏幕中央为中心

### v3.2.0 - 视觉美化和修复
- 🎨 **战机外观美化**：所有战机从方块改为精美的飞船设计
- 🎯 **敌机生成修复**：彻底修复敌机在左侧边缘生成的问题，现在全部在屏幕中央生成
- 🎨 **背景优化**：完全移除水平移动的渐变矩形，背景更加简洁
- 🚀 **玩家飞船升级**：添加驾驶舱、引擎火焰动画、细节线条
- 👾 **敌人设计**：10种不同敌人类型各有独特的飞船外观
- ⚡ **性能优化**：移除不必要的背景效果，提升游戏流畅度
